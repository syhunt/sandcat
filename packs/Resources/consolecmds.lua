...
function M:AddCommands()
 ...
 console.addcmd('delay [ms]','ctk.utils.delay(cmd.params)','Waits a specific number of milliseconds before proceeding')
 ...
 console.addcmd('server','print(ctk.http.getheader(tab.rcvdheaders,"Server"))','Displays the server software')
